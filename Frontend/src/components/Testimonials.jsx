const Testimonials = () => {
  ...
  const CreateCard = ({ card }) => (
    <div id="testimonials" className="scroll-mt-44 p-4 rounded-xl mx-4 shadow-md hover:shadow-xl transition-all duration-200 w-72 shrink-0 bg-[#151522] border border-slate-700/50 backdrop-blur">
      ...
      <p className="text-sm py-4 text-slate-300">
        Radiant completely transformed our workflow — delivering sleek, reliable results faster than we imagined.
      </p>
    </div>
  );
  ...
  return (
    <>
      ...
      <p class="mt-25 text-center text-xl font-medium text-purple-400 px-10 py-1.5 rounded-full bg-purple-950 border border-purple-800 w-max mx-auto">Testimonials</p>
