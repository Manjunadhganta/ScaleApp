    ...
    const featuresData = [
        {
            ...
            description: "Optimized infrastructure ensures your application loads instantly and scales automatically with your growing user base.",
        },
        {
            ...
            description: "Built-in authentication system with support for email, social logins, and multi-factor authentication to keep your users safe.",
        },
        {
            ...
            description: "Comprehensive dashboard with real-time insights into user behavior, performance metrics, and business growth.",
        }
    ];
    return (
        <>
            <div class="text-center mt-25 scroll-mt-24 " id="features">
                <p class="text-center text-xl font-medium text-purple-400 px-10 py-1.5 rounded-full bg-purple-950 border border-purple-800 w-max mx-auto">Features</p>
                ...
                {featuresData.map((feature, index) => (
                    <div key={index} className={`hover:-translate-y-0.5 transition duration-300 ${index === 1 ? 'p-px rounded-[13px] bg-linear-to-br from-[#9544FF] to-[#223B60]' : ''}`}>
                        <div className="p-6 rounded-xl space-y-4 border border-slate-800 bg-slate-950 max-w-80 w-full">
                            ...
                            <p className="text-slate-400 line-clamp-4 pb-4">
                                {feature.description}
                            </p>
                        </div>
                    </div>
